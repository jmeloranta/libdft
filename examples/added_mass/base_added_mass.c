 ...
 * This version has "VEL" undefined. Intented to define via
 * sed in the run_all.sh script.
 */
...
#define OUTPUT    2000	/* output every this iteration */
#define THREADS 8	/* # of parallel threads to use */
#define NX 128       	/* # of grid points  x */
#define NY 128          /* # of grid points  y */
#define NZ 128        	/* # of grid points  z */
...
int main(int argc, char *argv[]) {
  ...
  dft_driver_read_grid(impwf->grid, "../impurity_final");
#endif
