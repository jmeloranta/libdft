...
int main(int argc, char **argv) {
  ...
  dft_driver_setup_grid(256, 256, 256, 0.5 /* Bohr */, 32 /* threads */);
  ...
  dft_common_potential_map(DFT_DRIVER_AVERAGE_NONE, "cu2-x-s-ccsdt.dat", "cu2-x-s-ccsdt.dat", "cu2-x-s-ccsdt.dat", ext_pot);
