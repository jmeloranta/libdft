...
#define DFT_DRIVER_BOUNDARY_ABSORB   1
#define DFT_DRIVER_BOUNDARY_DAMPING  2
#define DFT_DRIVER_BOUNDARY_ITIME    3
...
#define DFT_DRIVER_PROPAGATE_NORMAL  1
#define DFT_DRIVER_PROPAGATE_OTHER   2
